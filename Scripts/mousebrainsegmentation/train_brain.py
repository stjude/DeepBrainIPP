...
def fetch_mouse_data_files(modalities, group="Training", include_truth=True, return_subject_ids=False):
...
def fetch_training_data_files(return_subject_ids=False):
    return fetch_mouse_data_files(modalities=config["training_modalities"], return_subject_ids=return_subject_ids)
...
def main(overwrite=False):
    ...
    if overwrite or not os.path.exists(config["data_file"]):
        ...
        write_data_to_file(training_files, config["data_file"], image_shape=config["image_shape"],
                           subject_ids=subject_ids,isstructured=False)
